      ...
      <section id='functions' className="py-16 px-4 w-full bg-red-700 text-white">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="space-y-8">
              <div className="flex flex-col items-center">
                <Image src="/images/backgrounds/image (6).jpg" alt="Buscar" width={80} height={80} /> 
              ...
              <div className="flex flex-col items-center">
                <Image src="/images/backgrounds/image (4).jpg" alt="Contacta" width={80} height={80} />
              ...
              <div className="flex flex-col items-center">
                <Image src="/images/backgrounds/image (1).jpg" alt="Contrata" width={80} height={80} />
          ...
          <div className="flex flex-col items-center text-center mt-12 md:mt-0">
            ...
            <div className="space-y-8">
              <div className="flex flex-col items-center">
                <Image src="/images/backgrounds/image (2).jps" alt="Regístrate" width={80} height={80} className="mb-4 invert" />
                <h4 className="font-semibold text-2xl mb-2">1. Regístrate</h4>
                <p className="text-lg">Crea tu perfil y destaca tus habilidades.</p>
              </div>
              <div className="flex flex-col items-center">
                <Image src="/images/backgrounds/image (5).jpg" alt="Ofrece tus servicios" width={80} height={80} className="mb-4 invert" />
              ...
              <div className="flex flex-col items-center">
                <Image src="/images/backgrounds/image (3).jpg" alt="Obtén clientes" width={80} height={80} className="mb-4 invert" />
